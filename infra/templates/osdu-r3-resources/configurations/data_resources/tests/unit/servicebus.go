...
func appendServicebusTests(t *testing.T, description infratests.ResourceDescription) {
	...
	description["module.service_bus.azurerm_servicebus_subscription.subscription[3]"] = asMap(t, `{
	...
	description["module.service_bus.azurerm_servicebus_topic.sptopic[2]"] = asMap(t, `{
