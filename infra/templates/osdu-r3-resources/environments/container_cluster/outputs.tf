...
output "aks_kv_identity_client_id" {
  description = "The client id for the user identity"
  value       = module.aks-gitops.aks_user_identity_client_id
}

output "aks_kv_identity_resource_id" {
  description = "The client id for the user identity"
  value       = module.aks-gitops.aks_user_identity_id
}
